...
export interface SweepableBridgeReceiverHarnessInterface
...
export interface SweepableBridgeReceiverHarness extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SweepableBridgeReceiverHarnessInterface;
