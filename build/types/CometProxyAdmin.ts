...
export interface CometProxyAdminInterface extends utils.Interface {
  functions: {
    "changeProxyAdmin(address,address)": FunctionFragment;
    "deployAndUpgradeTo(address,address)": FunctionFragment;
    "deployUpgradeToAndCall(address,address,bytes)": FunctionFragment;
