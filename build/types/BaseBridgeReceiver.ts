...
export interface BaseBridgeReceiverInterface extends utils.Interface {
  functions: {
...
export interface BaseBridgeReceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseBridgeReceiverInterface;
