...
export interface CometHarnessInterface extends utils.Interface {
  functions: {
    ...
    "getAssetList(address)": FunctionFragment;
    ...
    "setBasePrincipal(address,int104)": FunctionFragment;
    "setCollateralBalance(address,address,uint128)": FunctionFragment;
    "setNow(uint256)": FunctionFragment;
    "setTotalsBasic((uint64,uint64,uint64,uint64,uint104,uint104,uint40,uint8))": FunctionFragment;
    "setTotalsCollateral(address,(uint128,uint128))": FunctionFragment;
    ...
    "updateAssetsInExternal(address,address,uint128,uint128)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setBasePrincipal",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setTotalsBasic",
    values: [TotalsBasicStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "setTotalsCollateral",
    values: [string, TotalsCollateralStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateAssetsInExternal",
...
export type SupplyEvent = TypedEvent<
  ...
  { from: string; dst: string; amount: BigNumber }
>;
...
export type SupplyCollateralEvent = TypedEvent<
  ...
  { from: string; dst: string; asset: string; amount: BigNumber }
>;
...
export type TransferCollateralEvent = TypedEvent<
  [string, string, string, BigNumber],
  { from: string; to: string; asset: string; amount: BigNumber }
>;
...
export type WithdrawEvent = TypedEvent<
  [string, string, BigNumber],
  { src: string; to: string; amount: BigNumber }
>;
...
export type WithdrawCollateralEvent = TypedEvent<
  [string, string, string, BigNumber],
  { src: string; to: string; asset: string; amount: BigNumber }
>;
...
export interface CometHarness extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CometHarnessInterface;
  ...
  functions: {
    ...
    getNow(overrides?: CallOverrides): Promise<[number]>;
    ...
    nowOverride(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    setTotalsBasic(
      totals: TotalsBasicStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    setTotalsCollateral(
      asset: string,
      totals: TotalsCollateralStruct,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    updateAssetsInExternal(
      account: string,
      asset: string,
      initialUserBalance: BigNumberish,
      finalUserBalance: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  getAssetList(account: string, overrides?: CallOverrides): Promise<string[]>;
  ...
  callStatic: {
    ...
    setNow(now_: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    nowOverride(overrides?: CallOverrides): Promise<PopulatedTransaction>;
