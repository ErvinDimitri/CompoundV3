...
export interface CometModifiedInterface extends utils.Interface {
  functions: {
...
export interface CometModified extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CometModifiedInterface;
  ...
  callStatic: {
    ...
    initialize(liquidator: string, overrides?: CallOverrides): Promise<void>;
