...
export interface LineaBridgeReceiverInterface extends utils.Interface {
  functions: {
    ...
    "messageService()": FunctionFragment;
...
export interface LineaBridgeReceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LineaBridgeReceiverInterface;
  ...
  functions: {
    ...
    messageService(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    messageService(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    messageService(overrides?: CallOverrides): Promise<PopulatedTransaction>;
