...
export interface SweepableBridgeReceiverInterface extends utils.Interface {
  functions: {
...
export interface SweepableBridgeReceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SweepableBridgeReceiverInterface;
